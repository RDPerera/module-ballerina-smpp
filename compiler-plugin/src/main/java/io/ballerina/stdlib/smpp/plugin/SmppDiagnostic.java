 ...
 *       name), {@code SMPP_103} (missing {@code remote}), {@code SMPP_104} (resource
 *       method), {@code SMPP_105} (return type never inspected at runtime), and
 *       {@code SMPP_112} (isolation: legal, but silently serializes every dispatch on
 *       the runtime's process-wide lock).</li>
 ...
 *       failure, but they are not this plugin's core justification.</li>
 * </ul>
 */
