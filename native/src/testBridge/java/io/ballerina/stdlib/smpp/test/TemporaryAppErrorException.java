 ...
 * either a SYNC handler returning an error, or a PDU arriving while no service is
 * attached at all (the transient startup/teardown window, where retention and
