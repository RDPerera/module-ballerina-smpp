 ...
 * connector NACKing a PDU type the attached service does not implement.
 *
 ...
 * the connector into {@code RX_T_APPN}, so a wrong exception type connector-side silently
 * degrades this permanent NACK into a transient one — a guaranteed redelivery poison loop.
 * Only asserting the exact decoded status at the mock catches that class of regression.
 */
